...
Although the "Big One" can be very concerning, earthquakes in general are actually quite common. For example, based on USGS data (<https://www.kaggle.com/datasets/farazrahman/earthquake>), in just the past month, there has been 9400 earthquakes in the US according to @tbl-monthly-count .
