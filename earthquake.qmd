...
In order to most successfully answer our research questions below, we must first set up our environment with the appropriate packages and then import and prepare the data for analysis.
